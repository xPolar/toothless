export default {
	...
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_DESCRIPTION: "Manage the auto reactions for your server.",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_ADD_SUB_COMMAND_NAME: "add",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_ADD_SUB_COMMAND_DESCRIPTION: "Add an auto reaction to a channel.",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_ADD_SUB_COMMAND_CHANNEL_OPTION_NAME: "channel",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_ADD_SUB_COMMAND_CHANNEL_OPTION_DESCRIPTION:
		"The channel to add an auto reaction to.",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_ADD_SUB_COMMAND_EMOJI_OPTION_NAME: "emoji",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_ADD_SUB_COMMAND_EMOJI_OPTION_DESCRIPTION: "The emoji to react with.",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_REMOVE_SUB_COMMAND_NAME: "remove",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_REMOVE_SUB_COMMAND_DESCRIPTION: "Remove an auto reaction from a channel.",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_REMOVE_SUB_COMMAND_CHANNEL_OPTION_NAME: "channel",
	...
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_REMOVE_SUB_COMMAND_EMOJI_OPTION_NAME: "emoji",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_REMOVE_SUB_COMMAND_EMOJI_OPTION_DESCRIPTION: "The emoji to remove.",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_LIST_SUB_COMMAND_NAME: "list",
	CONFIG_AUTO_REACTION_SUB_COMMAND_GROUP_LIST_SUB_COMMAND_DESCRIPTION: "List all auto reactions.",

	CONFIG_DONT_LOG_BOT_DELETES_SUB_COMMAND_NAME: "dont_log_bot_deletes",
	CONFIG_DONT_LOG_BOT_DELETES_SUB_COMMAND_DESCRIPTION: "Toggle whether or not bot deletes should be logged.",

	AUTO_REACTION_ADDED_TITLE: "Auto Reaction Added",
	AUTO_REACTION_ADDED_DESCRIPTION: "{{emoji}} will now be added to {{channel}}!",

	AUTO_REACTION_REMOVED_TITLE: "Auto Reaction Removed",
	AUTO_REACTION_REMOVED_DESCRIPTION: "{{emoji}} will no longer be added to {{channel}}!",
	...
	SELECT_ROLE_COMMAND_DESCRIPTION: "Manage select menu roles for your server.",

	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_NAME: "add",
	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_DESCRIPTION: "Add a select menu option to a message.",
	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_CHANNEL_OPTION_NAME: "channel",
	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_CHANNEL_OPTION_DESCRIPTION: "The channel to add a select menu option to.",
	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_MESSAGE_OPTION_NAME: "message",
	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_MESSAGE_OPTION_DESCRIPTION: "The message to add a select menu option to.",
	...
	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_LABEL_OPTION_DESCRIPTION: "The label of the select menu option.",
	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_EMOJI_OPTION_NAME: "emoji",
	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_EMOJI_OPTION_DESCRIPTION: "The emoji of the select menu option.",
	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_DESCRIPTION_OPTION_NAME: "description",
	SELECT_ROLE_COMMAND_CREATE_SUB_COMMAND_DESCRIPTION_OPTION_DESCRIPTION: "The description of the select menu option.",
	...
	INVALID_POSITION_DESCRIPTION: "The position must be between {{min}} and {{max}}.",

	SELECT_ROLE_COMMAND_DELETE_SUB_COMMAND_NAME: "remove",
	SELECT_ROLE_COMMAND_DELETE_SUB_COMMAND_DESCRIPTION: "Remove a select menu option from a message.",
	SELECT_ROLE_COMMAND_DELETE_SUB_COMMAND_CHANNEL_OPTION_NAME: "channel",
	SELECT_ROLE_COMMAND_DELETE_SUB_COMMAND_CHANNEL_OPTION_DESCRIPTION: "The channel to remove a select menu option from.",
	SELECT_ROLE_COMMAND_DELETE_SUB_COMMAND_MESSAGE_OPTION_NAME: "message",
	SELECT_ROLE_COMMAND_DELETE_SUB_COMMAND_MESSAGE_OPTION_DESCRIPTION: "The message to remove a select menu option from.",
	SELECT_ROLE_COMMAND_DELETE_SUB_COMMAND_LABEL_OPTION_NAME: "label",
	SELECT_ROLE_COMMAND_DELETE_SUB_COMMAND_LABEL_OPTION_DESCRIPTION: "The label of the select menu option.",

	SELECT_ROLE_COMMAND_LIST_SUB_COMMAND_NAME: "list",
	SELECT_ROLE_COMMAND_LIST_SUB_COMMAND_DESCRIPTION: "List all select menu roles for the server.",

	SELECT_ROLE_ADDED_TITLE: "Select Menu Role Added",
	SELECT_ROLE_ADDED_DESCRIPTION: "{{roles}} will now be given to users who select the option **{{label}}**!",

	SELECT_ROLE_REMOVED_TITLE: "Select Menu Role Removed",
	SELECT_ROLE_REMOVED_DESCRIPTION: "{{roles}} will no longer be given to users who select the option **{{label}}**!",

	SELECT_ROLE_NOT_FOUND_TITLE: "Select Menu Role Not Found",
	SELECT_ROLE_NOT_FOUND_DESCRIPTION: "A select menu role with the label **{{label}}** was not found!",

	SELECT_ROLE_LIST_TITLE: "Select Menu Roles",

	ROLES_EDITED_TITLE: "Roles Edited",

	DONT_LOG_BOT_DELETES_ENABLED_TITLE: "Don't Log Bot Deletes Enabled",
	DONT_LOG_BOT_DELETES_ENABLED_DESCRIPTION: "I won't log bot deletes in this server anymore.",

	DONT_LOG_BOT_DELETES_DISABLED_TITLE: "Don't Log Bot Deletes Disabled",
	DONT_LOG_BOT_DELETES_DISABLED_DESCRIPTION: "I will log bot deletes in this server again.",
};
